...
from gordo_components.machine.model.models import (
...
from gordo_components.machine.model.factories import lstm_autoencoder
...
def test_keras_autoencoder_scoring(model, kind, n_features_out):
    ...
    """
    Model = pydoc.locate(f"gordo_components.machine.model.models.{model}")
...
def test_keras_type_config(model, kind):
    ...
    assert isinstance(
        model_out, pydoc.locate(f"gordo_components.machine.model.models.{model}")
    )
