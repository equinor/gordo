...
from gordo_components.machine.model.factories.feedforward_autoencoder import (
...
class FeedForwardAutoEncoderTestCase(unittest.TestCase):
    @mock.patch(
        "gordo_components.machine.model.factories.feedforward_autoencoder.feedforward_model",
