...
from gordo_components.machine.dataset.data_provider.azure_utils import (
    create_adls_client,
)
...
from gordo_components.machine.dataset.data_provider.iroc_reader import IrocReader
from gordo_components.machine.dataset.data_provider.ncs_reader import NcsReader
...
def load_series_from_multiple_providers(
    ...
    :class:`gordo_components.machine.dataset.data_provider.base.GordoBaseDataProvider` provided in the
    parameter `data_providers`. Will load a tag from the first data provider in the list
    which claims it. See
    :func:`gordo_components.machine.dataset.data_provider.base.GordoBaseDataProvider.load_series`.
