...
from gordo_components.machine.dataset.filter_rows import pandas_filter_rows
    ...
    def __init__(
        ...
        **_kwargs,
        ...
        row_filter: str
            ...
            See :func:`gordo_components.machine.dataset.filter_rows.pandas_filter_rows` for
...
class RandomDataset(TimeSeriesDataset):
    ...
    gordo_components.machine.dataset.data_provider.providers.RandomDataProvider
    """
