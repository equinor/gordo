...
from gordo_components.machine.model.anomaly.base import AnomalyDetectorBase
...
class DiffBasedAnomalyDetector(AnomalyDetectorBase):
    def __init__(
        ...
        base_estimator: sklearn.base.BaseEstimator
            ...
            defaults to py:class:`gordo_components.machine.model.models.KerasAutoEncoder` with
