...
from gordo_components.workflow.workflow_generator.helpers import _get_sanitized_string
...
class Dataset(ConfigElement):
    ...
    @property
    def sanitized_tags(self):
        return [_get_sanitized_string(tag) for tag in self.tags]
